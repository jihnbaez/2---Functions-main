...
func progressUpdate(goal:Int, steps:Int){
    if (goal / 10) < steps {
        print("You're are off to a good start.")
    }
...
progressUpdate(goal: 9, steps: 100)
progressUpdate(goal: 34, steps: 100)
progressUpdate(goal: 68, steps: 100)
progressUpdate(goal: 92, steps: 100)
progressUpdate(goal: 100, steps: 100)
